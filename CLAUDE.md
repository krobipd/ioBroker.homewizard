...
| ------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.13.0 | 2026-06-24 | In-Depth Code- + Security-Audit: per-Device-TLS-CN-Pinning (D6-1, LAN-MITM→Token-Harvest geschlossen, per v2-Doku) + minVersion TLS1.2, manual-IP-Pairing-Filter per Identität (D1-1) + deleteUser-bei-Reject, unhandled-rejection-Härtung (D2-3, 4× `.catch`), getDeviceInfo-Validierung (D3-3), Response-16MB-Cap + WS-maxPayload + Push-Backpressure + IPv4-Ingress-Validierung + pairingIp-Range-Guard + api_v1-Enable-Warn + CA-Ablauf-2031-Warn, WS-Auth-Error-Verdrahtung, protocol_version/unique_id-States (11-sprachig). D4-1/D4-2/D4-3-Test-Findings gefixt. 331 unit + 57 package, Coverage 88,5 %. |
