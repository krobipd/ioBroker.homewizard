...
- **Version:** 0.9.3 (released 2026-05-24, memory/perf audit fixes: TimerDeps injection in websocket-client for compact-mode compliance, preserve user-modified device names on extendObjectAsync in state-manager + main.ts). Vorgänger **0.9.2** changelog user-centric rewrite. 231 unit + 57 package = 288 tests.
